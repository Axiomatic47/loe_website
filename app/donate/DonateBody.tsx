// app/donate/DonateBody.tsx — client body of the donation page (port of
// src/views/Donate.tsx; PayPal SDK loads client-side). The client id comes
// from NEXT_PUBLIC_PAYPAL_CLIENT_ID (the vite side reads VITE_PAYPAL_CLIENT_ID
// — both must be set in the deploy environment at cutover).
'use client';

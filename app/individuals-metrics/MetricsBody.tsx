// app/individuals-metrics/MetricsBody.tsx — client body of the Individual
// Supremacism Metrics explorer (port of src/views/IndividualsMetrics.tsx;
// search/filter/sort/detail state).
'use client';
      ...
      <div className="container mx-auto px-4 py-12 flex-grow">
        <BlurPanel>
          ...
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-4xl font-serif text-foreground">Individual Supremacism Metrics</h1>
          ...
          <Alert className="bg-card/80 border-border mb-6">
            ...
            <AlertTitle className="text-foreground">Individual Supremacism Analysis</AlertTitle>
          ...
          <Tabs defaultValue="table" className="w-full">
            ...
            <TabsContent value="table">
                  ...
                  <div className="flex flex-col sm:flex-row justify-between mb-4 gap-4">
                    <div className="flex-1 max-w-md">
                      <div className="relative">
                        <Search className="absolute left-2 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground/80" />
                        <Input
                    ...
                    <div className="flex items-center gap-2">
                      <Filter className="h-4 w-4 text-muted-foreground/80" />
                      <select
                        value={selectedCategory}
                        onChange={(e) => setSelectedCategory(e.target.value)}
                        className="bg-card text-foreground border border-border rounded p-2"
                      >
                          ...
                          >
                            <div className="flex items-center justify-center">
                              ...
                              <div className="ml-1 group relative">
                                ...
                                <div className="opacity-0 group-hover:opacity-100 absolute bottom-full left-1/2 transform -translate-x-1/2 w-48 bg-card text-foreground text-xs p-2 rounded transition-opacity duration-200 pointer-events-none">
                          ...
                          filteredIndividuals.map(ind => (
                            ...
                            >
                              <td className="px-6 py-4">
                                <div className="text-foreground font-medium">{ind.name}</div>
                                <div className="text-muted-foreground/80 text-sm">{ind.position}</div>
                              </td>
                              <td className="px-6 py-4 text-muted-foreground">
                                {ind.country}
                              </td>
                              <td className="px-6 py-4 text-center">
                                <span className="text-muted-foreground">{ind.ips.toFixed(1)}</span>
                              </td>
                              <td className="px-6 py-4 text-center">
              ...
              {selectedIndividual && (
                <div className="mt-8 bg-card/80 rounded-lg border border-border p-6">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h2 className="text-2xl text-foreground font-medium">{selectedIndividual.name}</h2>
                      <p className="text-muted-foreground/80">{selectedIndividual.position} • {selectedIndividual.country}</p>
                    </div>
                    <Button
                      variant="outline"
                      size="sm"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div className="bg-card/60 rounded-lg p-4 border border-border">
                      ...
                      <p className="text-xs text-muted-foreground/80 mt-2">Measures global influence and reach</p>
                    </div>

                    <div className="bg-card/60 rounded-lg p-4 border border-border">
                      <div className="flex justify-between items-center mb-2">
                        <h3 className="text-muted-foreground">Supremacist Rhetoric Score</h3>
                      ...
                      <p className="text-xs text-muted-foreground/80 mt-2">Measures supremacist language and messaging</p>
                    </div>

                    <div className="bg-card/60 rounded-lg p-4 border border-border">
                      <div className="flex justify-between items-center mb-2">
                        <h3 className="text-muted-foreground">Policy Action Score</h3>
                      ...
                      <p className="text-xs text-muted-foreground/80 mt-2">Measures implemented policies or actions</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-card/60 rounded-lg p-4 border border-border">
                      ...
                      <div className="mt-4">
                        <p className="text-muted-foreground text-sm">{selectedIndividual.description}</p>
                      </div>
                    </div>

                    <div className="bg-card/60 rounded-lg p-4 border border-border">
                      <h3 className="text-foreground mb-3">Key Indicators</h3>
                      ...
                      <div className="mt-4 text-right text-xs text-muted-foreground/80">
            ...
            <TabsContent value="categories">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-card/60 p-6 rounded-lg border border-border">
                  <h2 className="text-xl text-foreground mb-4">Supremacism by Category</h2>
                ...
                <div className="bg-card/60 p-6 rounded-lg border border-border">
                  <h2 className="text-xl text-foreground mb-4">Regional Comparisons</h2>
                  <div className="space-y-6">
                    <div>
                      <div className="flex justify-between text-sm text-muted-foreground/80 mb-1">
                ...
                <div className="md:col-span-2 bg-card/60 p-6 rounded-lg border border-border">
                  <h2 className="text-xl text-foreground mb-4">Top 5 Most Influential Individuals by ISC Score</h2>
                      ...
                      .map(ind => (
                        <div key={ind.id} className="bg-card/80 p-4 rounded-lg border border-border">
                          <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-muted-foreground/80 text-sm">{ind.position}</p>
                            <p className="text-muted-foreground/70 text-xs">{ind.country}</p>
                          </div>
                        </div>
                      ))}
                  </div>
            ...
            <TabsContent value="methodology">
              <div className="bg-card/60 p-6 rounded-lg border border-border">
                <h2 className="text-2xl text-foreground mb-4">Individual Supremacism Scoring Methodology</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <div className="bg-card/80 p-4 rounded-lg border border-border mb-4">
                      ...
                      <p className="text-muted-foreground/80 text-sm">This formula weights actions higher than rhetoric, while accounting for the amplifying effect of prominence.</p>
                    </div>

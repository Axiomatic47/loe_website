// app/contact/ContactBody.tsx — client body of the contact page (port of
// src/views/Contact.tsx; FormSubmit.co form with inquiry-type selector).
'use client';
...
export const ContactBody = () => {
  ...
  // Check for success parameter in URL (window-read on mount — same behavior
  // as the vite router read, without a useSearchParams Suspense boundary)
  useEffect(() => {

// app/constitutional-accountability/AccountabilityBody.tsx — client body of
// the Constitutional Authority Map (port of src/views/ConstitutionalAccountability.tsx).
// Interactive exploration tool based on the Madisonian Separation of Powers
// Compliance Framework. The map data arrives as a server prop (read from
// public/data/ at build) — no runtime fetch, no loading/error states.
'use client';
...
export const AccountabilityBody = ({ data }: { data: ConstitutionalAuthorityMap }) => {
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-card rounded-xl border border-border p-6 mb-8">
                ...
                <div className="bg-secondary/60 border border-border rounded-lg p-4 mb-4">
                  <div className="text-foreground/85 font-semibold mb-3 text-center">Madisonian Six-Step Test</div>
                  <div className="grid grid-cols-1 md:grid-cols-6 gap-2 text-xs">
                    {data.compliance_tools.madisonian_test.steps.map((step, idx) => (
                      <div key={idx} className="bg-card/80 rounded-lg p-2 border border-border">
                        <div className="text-foreground/85 font-semibold mb-1">Step {step.step}</div>
                ...
                <div className="bg-card border border-border rounded-lg p-4">
                  <div className="text-foreground/85 font-semibold mb-3 text-center text-sm">
                    Madison's "Balance and Check" Framework
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div className="bg-secondary/60 border border-border border-l-2 border-l-primary/60 rounded-lg p-3">
                      <div className="text-primary font-semibold mb-1">1. BALANCE</div>
                    ...
                    <div className="bg-secondary/60 border border-border rounded-lg p-3">
                      <div className="text-foreground/85 font-semibold mb-1">2. CHECK</div>
                      <div className="text-muted-foreground">
        ...
        <div className="mt-12 text-center">
          <div className="bg-card rounded-xl border border-border p-6 max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-4">
              This tool implements the <strong className="text-foreground/85">Madisonian Six-Step Compliance Test</strong> framework
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs mb-4">
              <div className="bg-secondary/60 border border-border border-l-2 border-l-destructive/60 rounded-lg p-3">
                <div className="text-destructive font-semibold mb-1">PRIMARY PSV</div>
                <div className="text-muted-foreground/80">Direct usurpation or abdication of an EAP</div>
              </div>
              <div className="bg-secondary/60 border border-border rounded-lg p-3">
                <div className="text-foreground/85 font-semibold mb-1">ENABLING PSV</div>
                <div className="text-muted-foreground/80">Law/doctrine permitting improper delegation</div>
              </div>
              <div className="bg-secondary/60 border border-border rounded-lg p-3">
                <div className="text-foreground/85 font-semibold mb-1">SHIELDING PSV</div>

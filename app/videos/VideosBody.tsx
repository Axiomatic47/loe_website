// app/videos/VideosBody.tsx — client body of the video evidence gallery
// (port of src/views/VideosPage.tsx; category filter + inline player state).
'use client';
...
export const VideosBody: React.FC = () => {

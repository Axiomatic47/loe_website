...
const ImageEnhancedMarkdownRenderer: React.FC<ImageEnhancedMarkdownProps> = ({
  ...
  const customComponents = {
    ...
    p: ({ node, children, ...props }: any) => (
      <p className="mb-4 leading-relaxed text-gray-100 drop-shadow" {...props}>
        {children}
        <InlineImageRenderer images={images} />
      </p>
    ),
    h1: ({ node, ...props }: any) => <h1 className="text-3xl font-serif mb-6 text-white drop-shadow-lg font-bold" {...props} />,
    h2: ({ node, ...props }: any) => <h2 className="text-2xl font-serif mb-4 text-white drop-shadow-lg font-bold" {...props} />,
    h3: ({ node, ...props }: any) => <h3 className="text-xl font-serif mb-3 text-white drop-shadow-lg font-semibold" {...props} />,
    h4: ({ node, ...props }: any) => <h4 className="text-lg font-serif mb-2 text-white drop-shadow-lg font-semibold" {...props} />,
    ul: ({ node, ...props }: any) => <ul className="list-disc pl-6 mb-4 text-gray-100" {...props} />,
    ol: ({ node, ...props }: any) => <ol className="list-decimal pl-6 mb-4 text-gray-100" {...props} />,
    li: ({ node, ...props }: any) => <li className="mb-2 text-gray-100 leading-relaxed" {...props} />,
    blockquote: ({ node, ...props }: any) => (
      <blockquote className="border-l-4 border-white/30 pl-4 italic my-6 text-gray-100 bg-black/20 p-4 rounded-r-lg shadow-sm" {...props} />
    ),
    a: ({ node, ...props }: any) => (
      <a className="text-blue-300 hover:text-blue-200 underline underline-offset-2 transition-colors" {...props} />
    ),
    em: ({ node, ...props }: any) => <em className="italic text-gray-100 font-medium" {...props} />,
    strong: ({ node, ...props }: any) => <strong className="font-bold text-white drop-shadow" {...props} />,
    ...
    th: ({ node, ...props }: any) => (
      <th className="border-b border-white/30 px-4 py-3 text-left text-white font-semibold bg-black/30" {...props} />
    ),
    td: ({ node, ...props }: any) => (
      <td className="px-4 py-3 text-gray-100 border-b border-white/20" {...props} />
    ),

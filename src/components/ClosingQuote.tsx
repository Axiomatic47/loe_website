// src/components/ClosingQuote.tsx — the site-wide closing quote field (vite
// renderer). Rendered by PageLayout at the tail of every page's scrolling
// content, directly above the fixed footer (owner 2026-09-08: a site-wide
// feature, same location on every page). Mirrors app/_components/ClosingQuote.tsx.

...
const CASES: Record<string, CaseConfig> = {
  johnson: {
    ...
    deadline:
      "The federal defendants moved to dismiss on July 15, 2026; Plaintiff’s opposition is due August 28, 2026; replies September 18, 2026.",
    ...
    timeline: [
      ...
      { date: "Jul 15, 2026", event: "Federal defendants’ motion to dismiss filed (Doc. 69)" },

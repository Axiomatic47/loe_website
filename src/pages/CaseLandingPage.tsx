...
const CASES: Record<string, CaseConfig> = {
  johnson: {
    ...
    deadline:
      "Defendants’ motions to dismiss are due July 15, 2026; Plaintiff’s opposition is due August 28, 2026; replies September 18, 2026.",
    ...
    timeline: [
      ...
      { date: "Jul 15, 2026", event: "Defendants’ motions to dismiss due", upcoming: true },

      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="space-y-8 text-gray-100">
          ...
          <section className="bg-black/85 backdrop-blur-sm border border-blue-500/30 rounded-xl p-8 shadow-xl">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">Capacity to Enter Agreement</h3>
          ...
          <section className="bg-black/85 backdrop-blur-sm border border-red-500/30 rounded-xl p-8 shadow-xl">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">2.1 Proprietary Rights</h3>
            <p className="mb-6 text-gray-200 leading-relaxed">
              All content, materials, technologies, and intellectual property on this Website, including but not limited to:
            </p>
            <ul className="list-disc list-inside mb-6 text-gray-200 space-y-2 ml-4">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">2.2 Prohibited Uses</h3>
            ...
            <h3 className="text-xl font-semibold text-white mb-4">2.3 Limited License</h3>
            <p className="mb-4 text-gray-200 leading-relaxed">
          ...
          <section className="bg-black/85 backdrop-blur-sm border border-purple-500/30 rounded-xl p-8 shadow-xl">
            <h2 className="text-3xl font-bold text-white mb-6">3. User Conduct and Responsibilities</h2>

            <h3 className="text-xl font-semibold text-white mb-4">3.1 Permitted Use</h3>
            <p className="mb-6 text-gray-200 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">3.2 Prohibited Conduct</h3>
            ...
            <h3 className="text-xl font-semibold text-white mb-4">3.3 Monitoring and Enforcement</h3>
            <p className="mb-4 text-gray-200 leading-relaxed">
          ...
          <section className="bg-black/85 backdrop-blur-sm border border-green-500/30 rounded-xl p-8 shadow-xl">
            <h2 className="text-3xl font-bold text-white mb-6">4. AI System Documentation and Evidence</h2>
            ...
            <h3 className="text-xl font-semibold text-white mb-4">4.1 Evidence Authenticity</h3>
            <p className="mb-6 text-gray-200 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">4.2 No Encouragement of Unauthorized Use</h3>
            <p className="mb-6 text-gray-200 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">4.3 Research and Academic Use</h3>
            <p className="mb-4 text-gray-200 leading-relaxed">
          ...
          <section className="bg-black/85 backdrop-blur-sm border border-blue-500/30 rounded-xl p-8 shadow-xl">
            <h2 className="text-3xl font-bold text-white mb-6">5. Privacy and Data Collection</h2>

            <h3 className="text-xl font-semibold text-white mb-4">5.1 Information Collection</h3>
            <p className="mb-6 text-gray-200 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">5.2 Analytics and Monitoring</h3>
            <div className="bg-blue-950/80 border border-blue-500/50 rounded-lg p-6 mb-6">
              <p className="text-blue-100 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">5.3 Security Measures</h3>
            <p className="mb-4 text-gray-200 leading-relaxed">
          ...
          <section className="bg-black/85 backdrop-blur-sm border border-orange-500/30 rounded-xl p-8 shadow-xl">
            <h2 className="text-3xl font-bold text-white mb-6">6. Disclaimers and Limitations of Liability</h2>

            <h3 className="text-xl font-semibold text-white mb-4">6.1 Website Provided "As Is"</h3>
            <div className="bg-orange-950/80 border border-orange-500/50 rounded-lg p-6 mb-6">
              <p className="text-orange-100 font-semibold leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">6.2 Information Accuracy</h3>
            <p className="mb-6 text-gray-200 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">6.3 Limitation of Liability</h3>
            <div className="bg-red-950/80 border border-red-500/50 rounded-lg p-6 mb-6">
              <p className="text-red-100 font-semibold leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">6.4 Professional Advice Disclaimer</h3>
            <p className="mb-4 text-gray-200 leading-relaxed">
          ...
          <section className="bg-black/85 backdrop-blur-sm border border-yellow-500/30 rounded-xl p-8 shadow-xl">
            <h2 className="text-3xl font-bold text-white mb-6">7. Indemnification</h2>
            ...
            <h3 className="text-xl font-semibold text-white mb-4">Defense and Settlement</h3>
            <p className="mb-4 text-gray-200 leading-relaxed">
          ...
          {/* Dispute Resolution */}
          <section className="bg-black/85 backdrop-blur-sm border border-purple-500/30 rounded-xl p-8 shadow-xl">
            <h2 className="text-3xl font-bold text-white mb-6">8. Dispute Resolution</h2>

            <h3 className="text-xl font-semibold text-white mb-4">8.1 Governing Law</h3>
            <p className="mb-6 text-gray-200 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">8.2 Jurisdiction and Venue</h3>
            <div className="bg-purple-950/80 border border-purple-500/50 rounded-lg p-6 mb-6">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">8.3 Limitation Period</h3>
            <p className="mb-6 text-gray-200 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">8.4 Injunctive Relief</h3>
            <p className="mb-4 text-gray-200 leading-relaxed">
          ...
          <section className="bg-black/85 backdrop-blur-sm border border-red-500/30 rounded-xl p-8 shadow-xl">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">9.1 Termination by Us</h3>
            <p className="mb-6 text-gray-200 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">9.2 Effect of Termination</h3>
            <div className="bg-red-950/80 border border-red-500/50 rounded-lg p-6 mb-6">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">9.3 No Liability for Termination</h3>
            <p className="mb-4 text-gray-200 leading-relaxed">
          ...
          {/* General Provisions */}
          <section className="bg-black/85 backdrop-blur-sm border border-gray-500/30 rounded-xl p-8 shadow-xl">
            <h2 className="text-3xl font-bold text-white mb-6">10. General Provisions</h2>

            <h3 className="text-xl font-semibold text-white mb-4">10.1 Entire Agreement</h3>
            <p className="mb-6 text-gray-200 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">10.2 Severability</h3>
            <p className="mb-6 text-gray-200 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">10.3 Waiver</h3>
            <p className="mb-6 text-gray-200 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">10.4 Assignment</h3>
            ...
            <h3 className="text-xl font-semibold text-white mb-4">10.5 Updates to Terms</h3>
            <p className="mb-4 text-gray-200 leading-relaxed">

// src/pages/ForJournalists.tsx — press reference page.
            ...
            <Reveal delay={200}>
              <div className="bg-card border border-border rounded-xl shadow-sm p-6 h-full">
                ...
                <ul className="space-y-3 mt-2 text-sm font-sans">
                  <li>
                    <Link to="/composition/manuscript" className="text-primary hover:text-primary/80 transition-colors" style={{ fontWeight: 550 }}>
                      The research framework
                    </Link>
                    <span className="text-muted-foreground"> — the Laws of Existence manuscripts underlying the litigation</span>
                  </li>
                  <li>
                    <Link to="/composition/data" className="text-primary hover:text-primary/80 transition-colors" style={{ fontWeight: 550 }}>
                      Evidence collections
                    </Link>
                    <span className="text-muted-foreground"> — AI system testimonies, forensic documentation, simulations</span>
                  </li>
                  <li>
                    <Link to="/scotus-shadow-docket" className="text-primary hover:text-primary/80 transition-colors" style={{ fontWeight: 550 }}>
                      SCOTUS Shadow Docket archive
                    </Link>
                    <span className="text-muted-foreground"> — emergency-docket research, 1952–present</span>
                  </li>
                  <li>
                    <Link to="/videos" className="text-primary hover:text-primary/80 transition-colors" style={{ fontWeight: 550 }}>
                      Video evidence
                    </Link>

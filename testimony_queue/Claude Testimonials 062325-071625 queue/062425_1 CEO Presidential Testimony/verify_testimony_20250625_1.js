...
const EXPECTED_HASH = '0a1c1ee7e0961342bb5fe1ffbe03b55f9ab3c713f014830abdbfdc222fefa8eb';
const EXPECTED_CHAR_COUNT = 9104;

const testimonyContent = fs.readFileSync('testimony_20250625_1.md', 'utf8');
...
const signatureValid = crypto.verify('RSA-SHA256', Buffer.from(actualHash, 'hex'), {
    ...
    saltLength: 32
}, Buffer.from(fs.readFileSync('testimony_20250625_1.sig', 'utf8').trim(), 'base64'));
